...
@pytest.fixture
def set_positions(Atoken, Btoken, NFTContract, deployLibrary, ABPool):
    # fetch the accounts
    account = accounts[0]
...
def test_quoter(Atoken, Btoken, NFTContract, deployLibrary, ABPool, quoterContract, set_positions):
    # fetch the accounts
    account = accounts[0]
